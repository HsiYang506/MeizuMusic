...
import com.jywkhyse.meizumusic.domain.GetMusicByAlbumUseCase
...
class AlbumDetailsViewModel @Inject constructor(
    private val useCase: GetMusicByAlbumUseCase
) : ViewModel() {
    ...
    fun onAlbumIdChanged(albumId: Long) {
        _albumId.value = albumId
        Log.d("AlbumDetailsViewModel", "onAlbumIdChanged: $albumId")
        if (_albumId.value == -1L) {
