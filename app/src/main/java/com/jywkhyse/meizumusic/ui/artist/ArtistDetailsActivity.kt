...
class ArtistDetailsActivity : AppCompatActivity() {
    ...
    private fun setupRecyclerView() {
        ...
        binding.recyclerView.apply {
            ...
            layoutManager = LinearLayoutManager(this@ArtistDetailsActivity)
        }
    }
    ...
    private fun setupActionBar() {
        ...
        supportActionBar?.title = intent.getStringExtra("name") ?: "歌手详情"
    ...
    private fun observeViewModel() {
        viewModel.onArtistIdChanged(intent.getLongExtra("id", -1))
