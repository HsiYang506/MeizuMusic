...
import com.jywkhyse.meizumusic.domain.GetMusicByFolderUseCase
...
class FolderDetailsViewModel @Inject constructor(
    private val useCase: GetMusicByFolderUseCase
) : ViewModel() {
    ...
    fun onFolderChanged(folder: String) {
        ...
        Log.d("AlbumDetailsViewModel", "onAlbumIdChanged: $folder")
        if (_folder.value.isBlank()) {
